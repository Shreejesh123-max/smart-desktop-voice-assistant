...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'wikipedia' in query:
        ...
        elif 'open linkdin' in query or 'open linkedin' in query or 'open link den' in query:
           speak("Opening LinkedIn")
           webbrowser.open("https://www.linkedin.com")


        elif 'open leetcode' in query or 'open lead code' in query or 'open lit code' in query:
          print("Opening LeetCode block triggered")  # debug
          ...
          webbrowser.open("https://leetcode.com")
            ...
            try:
                jsonObj = urlopen('''https://newsapi.org/v1/articles?source=the-times-of-india&sortBy=top&apiKey=YourAPIKey''')
